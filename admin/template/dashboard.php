                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                voters</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?=$voters?></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 mb-7">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <?php
                                        if((!isset($polling_box))||($polling_box == false)){

                                        }else{
                                            foreach($polling_box as $r){
                                                $name = $r['presidential_name'];
                                                $percentage = (($r['total_vote'] * 100) / $total_vote);
                                                ...
                                                <div class='progress mb-4'>
                                                    <div class='{$color}' role='progressbar' style='width: {$percentage}%'
